...
<body>
    ...
    <script>
        (function() {
            ...
            document.documentElement.setAttribute("data-topbar", savedTheme === "dark" ? "dark" : "light");
            document.documentElement.setAttribute("data-sidebar", savedTheme === "dark" ? "dark" : "light");
