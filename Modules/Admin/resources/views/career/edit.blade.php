...
@section('content')
    <!-- form start -->
    <form method="POST" action="{{ route('careers.update', base64_encode($career->id)) }}">
        @csrf
        @method('PUT')
        <div class="row">
            <x-admin::action-buttons :cancel-url="route('careers.index')" save-label="Update" />
            <div class="col-md-8">
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="short_description" id="short_description" class="form-control" required>{{ $career->short_description }}</textarea>
                                    <span class="error-block"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control ckeditor" required>{{ $career->description }}</textarea>
                                    <span class="error-block"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control numeric-input" id="sort_order"
                                        name="sort_order" value="{{ $career->sort_order }}">
                                    <span class="error-block"></span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" name="status">
                                        <option value="1" @selected($career->status == 1)>Enabled</option>
                                        <option value="0" @selected($career->status == 0)>Disabled</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" id="job_type_id" name="job_type_id"
                                        ...
                                        @foreach ($jobTypes as $jobType)
                                            <option value="{{ $jobType->id }}" @selected($jobType->id == $career->job_type_id)>
                                                {{ $jobType->title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control numeric-input" id="experience"
                                        name="experience" value="{{ $career->experience }}" required>
                                    <span class="error-block"></span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control select2" id="state_id" name="state_id"
                                        ...
                                        @foreach ($states as $state)
                                            <option value="{{ $state->id }}" @selected($state->id == $career->state_id)>
                                                {{ $state->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control" id="city_id" name="city_id" required>
                                        ...
                                        @foreach ($cities as $city)
                                            <option value="{{ $city->id }}" @selected($city->id == $career->city_id)>
                                                {{ $city->name }}
                                            </option>
                                        @endforeach
                                    </select>
